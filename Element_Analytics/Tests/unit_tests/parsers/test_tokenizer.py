...
class TestTokenizer(unittest.TestCase):
    ...
    def test_solr(self):
        ...
        self.assertEqual(tokens[2], "INFO")
        self.assertEqual(tokens[3], "org.apache.solr.update.processor.LogUpdateProcessor")
        self.assertEqual(tokens[4], "[collection1] webapp=/solr path=/update params={waitSearcher=true&commit=" +
    ...
    def test_solr_commit(self):
        ...
        self.assertEqual(tokens[0], "Aug 20 06:39:02")
        self.assertEqual(tokens[1], "dchq_solr[38866]")
        self.assertEqual(tokens[2], "011commit{dir=NRTCachingDirectory(MMapDirectory@/opt/solr-4.10.4/example/" +
                                    "solr/collection1/data/index lockFactory=NativeFSLockFactory@/opt/solr-4.10.4/" +
                                    "example/solr/collection1/data/index; maxCacheMB=48.0 maxMergeSizeMB=4.0)," +
                                    "segFN=segments_7d8f,generation=343743}")
